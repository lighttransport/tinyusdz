#!/usr/bin/env bash
#
# tusdrender experimental BSDF sampling regression. A reflective quad over a red
...
read -r LR LG LB BR BG BB < <(
  python3 - "$REPO_ROOT/examples/tusdview/tests" \

#!/usr/bin/env python3
"""tusdrender legacy-path texture regression.
...
Usage: check_legacy_texture.py <tusdrender> <repo_root> <work_dir>
...
def main():
    if len(sys.argv) < 4:
        print("usage: check_legacy_texture.py <tusdrender> <repo_root> <work_dir>")
        return SKIP
    ...
    scene2 = os.path.join(repo, "models", "tusdview-material-binding-inheritance.usda")

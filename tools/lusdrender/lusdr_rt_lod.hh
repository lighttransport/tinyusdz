...
// lusdrender -- view-dependent per-instance LOD selection for the two-level
// (TLAS) render path. Native port of examples/lusdview/rt_lod.{hh,cc}: given the
...
// the TLAS). Pure math in lusdr's own Vec3 type (no light3d), unit-testable.
//
...
#include "lusdr_types.hh"  // lusdr::Vec3, CameraFrame, Bounds
...
// examples/lusdview/lod_math.hh BoxFitXform.

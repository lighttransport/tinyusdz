#!/usr/bin/env python3
"""Headless CPU lusdrender regression for deep connected MaterialX graphs."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="lusdrender-mtlx-cpu-") as tmp:
        ...
        if not output.is_file() or output.stat().st_size < 500:
            ...
            return 1
    print("CPU lusdrender deep MaterialX graph: pass")
    return 0

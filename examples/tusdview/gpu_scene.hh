...
struct DrawLightRtOpenPBRCPU {
  // Mirrors lightrt/examples/mtlxrender OpenPBRParams. This is a baked constant
  // fallback for raster/RT backends; texture-connected inputs keep their
  // texture ids in DrawMaterialParamCPU and the legacy material slots.

...
const char* UsageText() {
  return
      ...
      "\n"
      "usage: lusdquicklook [file-or-dir] [options]\n"
      "\n"
...
bool ParseOptions(int argc, char** argv, Options* opts, bool* want_help,
  ...
  *want_help = false;
  ...
  if (opts->mcp_stdio || opts->mcp_http_port != 0) {
    *err = "MCP support is disabled; configure with -DLUSDQUICKLOOK_ENABLE_MCP=ON";
    return false;
  }
#endif

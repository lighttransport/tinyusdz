...
# not a lusdview CLI option; headless dimensions come from the config. Keep the
...
# hardware/virtual GPU is also visible, let lusdview's normal device selection

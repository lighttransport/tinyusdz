...
// canvas. The canvas draws streamed binary image frames (the full lusdview
...
int StreamServer::uploadHandler(mg_connection* conn, void* u) {
  ...
  std::filesystem::path dir =
      std::filesystem::temp_directory_path(ec) / "lusdview_uploads";

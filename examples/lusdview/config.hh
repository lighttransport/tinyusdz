...
// lusdview - startup JSON config loading.
#pragma once
...
struct StartupConfig {
  ...
  std::optional<std::string> cudaRtBackend;  // auto | optix | software
...
// Default per-user ImGui state path, colocated with lusdview config.json.

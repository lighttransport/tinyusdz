...
//
// GeomPrimvar flatten_with_indices/get_value explicit instantiations (VEC_B group).
...
APPLY_GEOMPRIVAR_TYPE_VEC_B(INSTANCIATE_FLATTEN_WITH_INDICES)
APPLY_GEOMPRIVAR_TYPE_VEC_B(INSTANCIATE_GET_VALUE)

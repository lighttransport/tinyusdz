...
// SCALAR type group. Split from usdGeom.cc; shares bodies via usdGeom-primvar-impl.inc.
...
APPLY_GEOMPRIVAR_TYPE_SCALAR(INSTANCIATE_FLATTEN_WITH_INDICES)
APPLY_GEOMPRIVAR_TYPE_SCALAR(INSTANCIATE_GET_VALUE)

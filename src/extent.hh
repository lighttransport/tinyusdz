...
///
/// @file extent.hh
/// @brief USD Extent struct for bounding box calculations
///
/// The Extent struct represents an axis-aligned bounding box
/// used throughout USD for geometric bounds calculations.
///
#pragma once

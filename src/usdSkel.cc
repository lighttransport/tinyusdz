...
bool SkelAnimation::get_blendShapeWeights(std::vector<float> *vals, const double t, const TimeSampleInterpolationType tinterp) {
...
bool SkelAnimation::get_rotations(std::vector<value::quatf> *vals, const double t, const TimeSampleInterpolationType tinterp) {
  ...
  bool SkelAnimation::get_scales(std::vector<value::half3> *vals, const double t, const TimeSampleInterpolationType tinterp) {
  ...
  bool SkelAnimation::get_translations(std::vector<value::float3> *vals, const double t, const TimeSampleInterpolationType tinterp) {

...
// forward decl
#ifndef TINYUSDZ_NEW_VALUE_IMPLEMENTATION
namespace linb {
class any;
};
#endif  // TINYUSDZ_NEW_VALUE_IMPLEMENTATION
...
#else // TINYUSDZ_NEW_VALUE_IMPLEMENTATION
//
// New optimized Value implementation (32 bytes, inspired by crate::ValueRep)
// Enabled with TINYUSDZ_NEW_VALUE_IMPLEMENTATION preprocessor flag
//
...
class Value {
 public:
  ...
  //
#ifdef TINYUSDZ_NEW_VALUE_IMPLEMENTATION_DEBUG

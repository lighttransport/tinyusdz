...
//
// TypedTimeSamples explicit template instantiations and get() implementations
// have been moved to split files for parallel compilation:
// - timesamples-inst-scalar.cc (scalar types + get() instantiations)
// - timesamples-inst-array.cc (role/matrix arrays + get() instantiations)
// - timesamples-inst-array-basic.cc (basic arrays + get() instantiations)
// - timesamples-get-impl.inc (get() template implementations)

...
//
// GeomPrimvar flatten_with_indices/get_value explicit instantiations (VEC_A group).
...
APPLY_GEOMPRIVAR_TYPE_VEC_A(INSTANCIATE_FLATTEN_WITH_INDICES)
APPLY_GEOMPRIVAR_TYPE_VEC_A(INSTANCIATE_GET_VALUE)

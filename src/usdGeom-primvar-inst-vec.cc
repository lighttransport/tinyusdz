...
// VEC type group. Split from usdGeom.cc; shares bodies via usdGeom-primvar-impl.inc.
...
APPLY_GEOMPRIVAR_TYPE_VEC(INSTANCIATE_FLATTEN_WITH_INDICES)
APPLY_GEOMPRIVAR_TYPE_VEC(INSTANCIATE_GET_VALUE)

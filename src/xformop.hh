...
///
/// @file xformop.hh
/// @brief USD Transform operations (XformOp) definitions
///
/// XformOp represents transformation operations in USD's transform stack.
/// These operations define how geometry and other objects are positioned,
/// rotated, and scaled in 3D space through ordered transform operations.
///
#pragma once
...
///
/// @brief USD Transform Operation
///
/// Represents a single transformation operation in USD's xformOpOrder stack.
/// XformOps define spatial transformations like translate, rotate, scale, etc.
/// Operations are applied in order and can have time-varying values.
///
struct XformOp {
  enum class OpType {
    // matrix

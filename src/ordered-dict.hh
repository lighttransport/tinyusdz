...
///
/// @file ordered-dict.hh
/// @brief OrderedDict container class
///
/// Simple Python-like OrderedDict implementation that preserves insertion order 
/// while providing O(1) key-based lookup. Used throughout USD data structures
/// where order matters.
///
#pragma once

...
//
// GeomPrimvar flatten_with_indices/get_value explicit instantiations (ROLE_B group).
...
APPLY_GEOMPRIVAR_TYPE_ROLE_B(INSTANCIATE_FLATTEN_WITH_INDICES)
APPLY_GEOMPRIVAR_TYPE_ROLE_B(INSTANCIATE_GET_VALUE)

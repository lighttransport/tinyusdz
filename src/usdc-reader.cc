...
bool Reader::Impl::ReconstructXform(
    uint64_t node_idx,
    const Node &node, const FieldValuePairVector &fields,
...
bool Reader::Impl::ReconstructGeomBasisCurves(
    const Node &node, const FieldValuePairVector &fields,
    const std::unordered_map<uint32_t, uint32_t> &path_index_to_spec_index_map,
    GeomBasisCurves *curves) {
...
bool Reader::Impl::ReconstructGeomSubset(
    const Node &node, const FieldValuePairVector &fields,
    const std::unordered_map<uint32_t, uint32_t> &path_index_to_spec_index_map,
...
bool Reader::Impl::ReconstructGeomMesh(
    const Node &node, const FieldValuePairVector &fields,
    const std::unordered_map<uint32_t, uint32_t> &path_index_to_spec_index_map,
    GeomMesh *mesh) {
  bool has_position{false};
...
bool Reader::Impl::ReconstructMaterial(
    const Node &node, const FieldValuePairVector &fields,
    const std::unordered_map<uint32_t, uint32_t> &path_index_to_spec_index_map,
    Material *material) {
  (void)material;
...
bool Reader::Impl::ReconstructShader(
    const Node &node, const FieldValuePairVector &fields,
    const std::unordered_map<uint32_t, uint32_t> &path_index_to_spec_index_map,
    Shader *shader) {
  (void)shader;
...
bool Reader::Impl::ReconstructPreviewSurface(
    const Node &node, const FieldValuePairVector &fields,
    const std::unordered_map<uint32_t, uint32_t> &path_index_to_spec_index_map,
...
bool Reader::Impl::ReconstructSkelRoot(
    const Node &node, const FieldValuePairVector &fields,
    const std::unordered_map<uint32_t, uint32_t> &path_index_to_spec_index_map,
    SkelRoot *skelRoot) {
...
bool Reader::Impl::ReconstructSkeleton(
    const Node &node, const FieldValuePairVector &fields,
    const std::unordered_map<uint32_t, uint32_t> &path_index_to_spec_index_map,
    Skeleton *skeleton) {
...
bool Reader::Impl::ReconstructSceneRecursively(
...
bool Reader::Impl::ReconstructScene(Scene *scene) {
  (void)scene;
...
bool Reader::Impl::ReadUSDC() {
  if (crate_reader) {
    delete crate_reader;
  }

  crate_reader = new crate::Reader(_sr, _num_threads);
...
Reader::Reader(StreamReader *sr, int num_threads) {
  impl_ = new Reader::Impl(sr, num_threads);
}
...
#if 0
bool Reader::ReadTOC() { return impl_->ReadTOC(); }

bool Reader::ReadBootStrap() { return impl_->ReadBootStrap(); }

bool Reader::ReadTokens() { return impl_->ReadTokens(); }

bool Reader::ReadStrings() { return impl_->ReadStrings(); }

bool Reader::ReadFields() { return impl_->ReadFields(); }

bool Reader::ReadFieldSets() { return impl_->ReadFieldSets(); }

bool Reader::ReadPaths() { return impl_->ReadPaths(); }

bool Reader::ReadSpecs() { return impl_->ReadSpecs(); }

bool Reader::BuildLiveFieldSets() { return impl_->BuildLiveFieldSets(); }
...
std::string Reader::GetError() { return impl_->GetError(); }

std::string Reader::GetWarning() { return impl_->GetWarning(); }

#if 0

size_t Reader::NumPaths() { return impl_->NumPaths(); }

Path Reader::GetPath(crate::Index index) { return impl_->GetPath(index); }
#endif

bool Reader::ReadUSDC() {

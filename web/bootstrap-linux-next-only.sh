...
# (TINYUSDZ_WASM_NEXT_ONLY=ON), no legacy loader. Output:
...
emcmake cmake -G Ninja -DCMAKE_BUILD_TYPE=MinSizeRel -DTINYUSDZ_WASM_NEXT_ONLY=ON -DCMAKE_VERBOSE_MAKEFILE=1 -Bbuild_next_only

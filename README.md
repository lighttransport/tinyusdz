...
Core loading feature(both USDA and USDC) is now working and production-grade(And no seg fault for corrupted USDC/USDZ input).
...
Remaining task for v0.8.0 release is to write examples, demos and utility functions(Tydra).

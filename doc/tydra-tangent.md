...
The industry-standard algorithm by Morten S. Mikkelsen. Uses the original C
implementation (`mikktspace.c`) under the [zlib license](../src/external/mikktspace/LICENSE)
via a callback wrapper.

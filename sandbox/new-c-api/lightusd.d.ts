/**
 * LightUSD TypeScript Definitions
 *
 * TypeScript definitions for LightUSD C API bindings.
...
declare const lightusd: LightUSD;

export default lightusd;
"""
LightUSD Python Bindings

Pure Python ctypes bindings for the LightUSD C99 API.
...
def _find_library():
    ...
    local_paths = [
        ...
        Path(__file__).parent / "liblightusd_c.a",
...
if _lib_path is None:
    raise RuntimeError(
        "Cannot find liblightusd_c. Make sure to build the C API first:\n"

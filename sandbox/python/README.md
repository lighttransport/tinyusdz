...
## Run with ASAN build of libc-lightusd.so

```
LD_PRELOAD=/mnt/data/local/clang+llvm-14.0.0-x86_64-linux-gnu-ubuntu-18.04/lib/clang/14.0.0/lib/x86_64-unkno  wn-linux-gnu/libclang_rt.asan.so python clightusd_test.py
```
...
- numpy
  - currently numpy is a required module to develop/test Python binding of LightUSD.
- typeguard
